...
pub fn build(b: *std.Build) void {
    ...
    lib.addIncludePath(b.path("source/include"));

    if (t.cpu.arch.isAARCH64()) {
        lib.addIncludePath(b.path("build/Linux-ARM-VFPv2-GCC"));
        lib.addIncludePath(b.path("source/ARM-VFPv2"));
        lib.addCSourceFiles(.{
            .files = &.{
    ...
    if (t.cpu.arch.isX86()) {
        lib.addIncludePath(b.path("source/8086-SSE"));
        lib.addIncludePath(b.path("build/Linux-x86_64-GCC"));
    ...
    lib.installHeader(b.path("source/include/softfloat.h"), "softfloat.h");
