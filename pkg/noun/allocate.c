...
u3a_mark_road()
{
...

  {
    ...
    qua_u[9]->siz_w = cel_w * sizeof(c3_n);
  }
...

  {
    ...
    qua_u[10]->siz_w = fre_w * sizeof(c3_n);
  }
...

  {
    ...
    qua_u[11]->siz_w = wee_w * sizeof(c3_n);
  }
