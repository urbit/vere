...
_ca_box_make_hat(c3_w len_w, c3_w ald_w, c3_w off_w, c3_w use_w)
{
  ...
  if ( c3y == u3a_is_north(u3R) ) {
    ...
    pad_w = c3_align(all_p, ald_w, C3_ALGHI)
      - all_p;
    siz_w = c3_align(len_w + pad_w, u3C.walign_w, C3_ALGHI); /* ;;: shouldn't be necessary. Consider factoring out and passing ald_w = 2 for normal walloc calls (and 4 for malloc) */
