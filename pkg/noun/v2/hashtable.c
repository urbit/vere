...
*/
static c3_w_new
_ch_v2_popcount(c3_w_new num_w)
{
...
*/
static void
_ch_v2_free_node(u3h_v2_node* han_u, c3_w_new lef_w)
{
  c3_w_new len_w = _ch_v2_popcount(han_u->map_w);
  c3_w_new i_w;
...
*/
void
_ch_v2_rewrite_node(u3h_v2_node* han_u, c3_w_new lef_w)
{
