...
_cr_sing_atom(u3_atom a, u3_noun b)
{
     ...
     || (c3n == u3a_is_pug(b)) )
  {
    ...
    c3_o a_bob = u3a_is_bob(a);
    c3_o b_bob = u3a_is_bob(b);

    //  bob vs bob: equal iff same mug bucket and sequence number
    //
...
*/
c3_t
u3r_chub_fit(c3_d *out_d, u3_atom a)
{
  if ( u3r_met(6, a) > 1 ) {
    return 0;
  }
