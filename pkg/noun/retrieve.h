...
#include "types.h"
    ...
    **/
      ...
      */
        c3_m
        u3r_mug_notes(const c3_n* key_d, c3_n len_w);
      ...
      */
      ...
      /* u3r_safe_note(): validate and retrieve note.
      */
        c3_o
