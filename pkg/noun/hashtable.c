...
static u3_weak
_ch_trim_slot(u3h_root* har_u, u3h_slot *sot_w, c3_w_new lef_w, c3_w_new rem_w);
...
static void _ch_slot_put(u3h_slot*, u3_noun, c3_w_new, c3_w_new, c3_w*);

/* _ch_node_add(): add to node.
*/
static u3h_node*
_ch_node_add(u3h_node* han_u, c3_w_new lef_w, c3_w_new rem_w, u3_noun kev, c3_w *use_w)
{
...
*/
static void*
_ch_some_add(void* han_v, c3_w_new lef_w, c3_w_new rem_w, u3_noun kev, c3_w *use_w)
{
  if ( 0 == lef_w ) {
...
void _hbreak() {}
static void
_ch_slot_put(u3h_slot* sot_w, u3_noun kev, c3_w_new lef_w, c3_w_new rem_w, c3_w* use_w)
{
...
*/
static c3_o
_ch_slot_del(u3h_slot* sot_w, u3_noun key, c3_w_new lef_w, c3_w_new rem_w)
{
...
*/
static c3_o
_ch_node_del(u3h_slot* sot_w, u3_noun key, c3_w_new lef_w, c3_w_new rem_w)
{
...
*/
static c3_o
_ch_some_del(u3h_slot* sot_w, u3_noun key, c3_w_new lef_w, c3_w_new rem_w)
{
  if ( 0 == lef_w ) {
...
*/
static u3_weak
_ch_trim_node(u3h_root* har_u, u3h_slot* sot_w, c3_w_new lef_w, c3_w_new rem_w)
{
...
*/
static u3_weak
_ch_trim_some(u3h_root* har_u, u3h_slot* sot_w, c3_w_new lef_w, c3_w_new rem_w)
{
  if ( 0 == lef_w ) {
...
_ch_node_hum(u3h_node* han_u, c3_w_new lef_w, c3_w_new rem_w, c3_w_new mug_w)
{
  ...
  if ( !BIT_SET(map_w, bit_w) ) {
    ...
    u3h_slot sot_w = han_u->sot_w[inx_w];
...
_ch_free_node(u3h_node* han_u, c3_w_new lef_w, c3_o pin_o)
{
  ...
  for ( i_w = 0; i_w < len_w; i_w++ ) {
    u3h_slot sot_w = han_u->sot_w[i_w];
    if ( _(u3h_slot_is_null(sot_w))) {
    }  else if ( _(u3h_slot_is_noun(sot_w)) ) {
...
u3h_free(u3p(u3h_root) har_p)
{
  ...
  for ( i_w = 0; i_w < 64; i_w++ ) {
    u3h_slot sot_w = har_u->sot_w[i_w];
...
*/
static u3h_slot
_ch_take_node(u3h_slot sot_w, c3_w_new lef_w, u3_funk fun_f)
{
  u3h_node* han_u = u3h_slot_to_node(sot_w);
  c3_w_new      len_w = _ch_popcount(han_u->map_w);
...
static void
_ch_relocate_slot(u3h_slot *sot_w, c3_w_new lef_w);

static void
_ch_relocate_node(u3h_slot *sot_w, c3_w_new lef_w)
{
  u3h_node* han_u = u3h_slot_to_node(*sot_w);
