...
static void _ch_slot_put(u3h_slot*, u3_noun, c3_w_tmp, c3_w_tmp, c3_n*);
...
*/
u3h_slot
_ch_two(u3h_slot had_w, u3h_slot add_w, c3_w_new lef_w, c3_w_tmp ham_w, c3_w_tmp mad_w)
{
  void* ret;
  ...
  if ( 0 == lef_w ) {
    ...
    if ( hop_w == tad_w ) {
      ...
      ret             = han_u;
      han_u->map_w    = ((c3_w_new)1 << hop_w) | ((c3_w_tmp)1 << tad_w);
