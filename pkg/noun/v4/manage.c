...
u3m_v4_migrate(void)
{
  ...
  c3_h* mem_w = ((c3_h*)(void*)u3_Loom) + u3a_walign;
  c3_h  siz_w = c3_wiseof(u3v_home);
  c3_h  len_w = u3C.wor_i - u3a_walign;
  c3_h* mat_w = c3_align(mem_w + len_w - siz_w, u3a_balign, C3_ALGLO);
