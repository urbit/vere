 ...
 u3we_bend_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam_2, &vex,
                               u3x_sam_3, &sab,
                               u3x_con, &van, 0)) ||
 ...
 u3we_cold_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &van, 0)) ||
         (c3n == u3r_baad(van, u3x_sam_2, &cus, u3x_sam_3, &sef, 0)) )
    {
      return u3m_bail(c3__fail);
    } else {
 ...
 u3we_cook_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &van, 0)) ||
         (c3n == u3r_baad(van, u3x_sam_2, &poq, u3x_sam_3, &sef, 0)) )
    {
      return u3m_bail(c3__fail);
    } else {
 ...
 u3we_here_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &van, 0)) ||
         (c3n == u3r_baad(van, u3x_sam_2, &hez, u3x_sam_3, &sef, 0)) )
    {
      return u3m_bail(c3__fail);
    }
    else {
...
*/
  ...
  u3we_pfix(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam_2, &vex, u3x_sam_3, &sab, 0)) ) {
 ...
 u3we_stag_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &van, 0)) ||
         (c3n == u3r_baad(van, u3x_sam_2, &gob, u3x_sam_3, &sef, 0)) )
    {
      return u3m_bail(c3__fail);
    } else {
 ...
 u3we_stew_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &con, 0)) ||
...
*/
  ...
  u3we_stir_fun(u3_noun cor)
  {
    ...
    if ( (c3n == u3r_baad(cor, u3x_sam, &tub, u3x_con, &van, 0)) ||
         (c3n == u3r_baad(van, u3x_sam_2, &rud,
                               u3x_sam_6, &raq,
                               u3x_sam_7, &fel,
                               0)) )
    {
