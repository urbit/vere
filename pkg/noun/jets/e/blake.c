...
#include "urcrypt.h"
  ...
  u3we_blake2b(u3_noun cor)
  {
    ...
    if ( ((u3_none == (msg = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
          (u3_none == (key = u3r_head_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor)))))) ||
          (u3_none == (out = u3r_tail_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor))))))) ||
  ...
  u3we_blake3_hash(u3_noun cor)
  {
    ...
    if ( ((u3_none == (out = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
          (u3_none == (msg = u3r_tail_weak(u3r_head_weak(u3r_tail(cor))))) ||
          (u3_none == (sam = u3r_head_weak(u3r_tail_weak(u3r_tail_weak(u3r_tail(cor))))))) ||
                u3ud(out) ||
                u3r_cell(msg, &wid, &dat) || u3ud(wid) || u3ud(dat) ||
  ...
  u3we_blake3_chunk_output(u3_noun cor)
  {
    ...
    if ( ((u3_none == (counter = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
          (u3_none == (msg = u3r_tail_weak(u3r_head_weak(u3r_tail(cor))))) ||
          (u3_none == (key = u3r_head_weak(u3r_head_weak(u3r_tail_weak(u3r_tail_weak(u3r_tail(cor))))))) ||
          (u3_none == (flags = u3r_tail_weak(u3r_head_weak(u3r_tail_weak(u3r_tail_weak(u3r_tail(cor)))))))) ||
                u3r_cell(msg, &wid, &dat) || u3ud(wid) || u3ud(dat) ||
                u3ud(key) || u3ud(flags))
    {
      return u3m_bail(c3__exit);
