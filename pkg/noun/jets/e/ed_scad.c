...
#include "urcrypt.h"
  ...
  u3wee_scad(u3_noun cor)
  {
    ...
    if ( (u3_none == (pub = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
         (u3_none == (sek = u3r_head_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor)))))) ||
         (u3_none == (sca = u3r_tail_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor)))))) ||
         (c3n == u3ud(pub)) ||
         (c3n == u3ud(sek)) ||
         (c3n == u3ud(sca)) ) {
      return u3m_bail(c3__exit);
  ...
  {
    u3_noun sek, sca;
    if ( (u3_none == (sek = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
         (u3_none == (sca = u3r_tail_weak(u3r_head_weak(u3r_tail(cor))))) ||
         (c3n == u3ud(sek)) ||
         (c3n == u3ud(sca)) ) {
      return u3m_bail(c3__exit);
    }
