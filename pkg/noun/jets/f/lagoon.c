         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            ...
            x_shape = u3nc(u3x_atom(n)+1, u3_nul);
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
