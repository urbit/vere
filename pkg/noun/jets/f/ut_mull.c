...
u3wfu_mull(u3_noun cor)
{
  ...
  if (  (u3_none == (gol = u3r_head_weak(u3r_head_weak(u3r_tail(cor))))) ||
        (u3_none == (dox = u3r_head_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor)))))) ||
        (u3_none == (gen = u3r_tail_weak(u3r_tail_weak(u3r_head_weak(u3r_tail(cor)))))) ||
