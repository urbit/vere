...
/* soft check on u3_none return from q jet
*/
  static inline u3_noun _soft_run(u3_noun a)
  {
    if (u3_none == a) {
      u3m_bail(c3__fail);
    }
...
*/
  u3_noun
  u3qi_la_add_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq
                   )
...
*/
  u3_noun
  u3qi_la_sub_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq
                   )
...
*/
  u3_noun
  u3qi_la_mul_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_div_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_mod_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_cumsum_real(u3_noun x_data,
                      u3_noun shape,
                      u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_argmin_real(u3_noun x_data,
                      u3_noun shape,
                      u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_argmax_real(u3_noun x_data,
                      u3_noun shape,
                      u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_ravel_real(u3_noun x_data,
                     u3_noun shape,
                     u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_min_real(u3_noun x_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_max_real(u3_noun x_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_abs_real(u3_noun x_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
    //  Fence on valid bloq size.
...
*/
  u3_noun
  u3qi_la_gth_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_adds_real(u3_noun x_data,
                    u3_noun n,
                    u3_noun shape,
                    u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_subs_real(u3_noun x_data,
                    u3_noun n,
                    u3_noun shape,
                    u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_muls_real(u3_noun x_data,
                    u3_noun n,
                    u3_noun shape,
                    u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_divs_real(u3_noun x_data,
                    u3_noun n,
                    u3_noun shape,
                    u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_mods_real(u3_noun x_data,
                    u3_noun n,
                    u3_noun shape,
                    u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_dot_real(u3_noun x_data,
                   u3_noun y_data,
                   u3_noun shape,
                   u3_noun bloq)
  {
...
*/
  u3_noun
  u3qi_la_linspace_real(u3_noun a,
                        u3_noun b,
                        u3_noun n,
                        u3_noun bloq)
  {
    ...
    switch (u3x_atom(bloq)) {
      case 4: ;
        ...
        c3_y* x_bytes16 = (c3_y*)u3a_malloc(((n+1)*2+1)*sizeof(c3_y));
        for (c3_d i = 1; i <= n; i++) {
          ((float16_t*)x_bytes16)[n-i] = f16_add(a16, f16_mul(i32_to_f16(i), interval16));
        }
        ((float16_t*)x_bytes16)[n] = a16;
        ((float16_t*)x_bytes16)[0] = b16;
        x_bytes16[(n+1)*2] = 0x1;  // pin head
        r_data = u3i_bytes(((n+1)*2+1)*sizeof(c3_y), x_bytes16);
        u3a_free(x_bytes16);
        break;
      ...
      case 5: ;
        ...
        c3_y* x_bytes32 = (c3_y*)u3a_malloc(((n+1)*4+1)*sizeof(c3_y));
        for (c3_d i = 1; i <= n; i++) {
          ((float32_t*)x_bytes32)[n-i] = f32_add(a32, f32_mul(i32_to_f32(i), interval32));
        }
        ((float32_t*)x_bytes32)[n] = a32;
        ((float32_t*)x_bytes32)[0] = b32;
        x_bytes32[(n+1)*4] = 0x1;  // pin head
        r_data = u3i_bytes(((n+1)*4+1)*sizeof(c3_y), x_bytes32);
        u3a_free(x_bytes32);
        break;
      ...
      case 6: ;
        ...
        c3_y* x_bytes64 = (c3_y*)u3a_malloc(((n+1)*8+1)*sizeof(c3_y));
        for (c3_d i = 1; i < n; i++) {
          ((float64_t*)x_bytes64)[n-i] = f64_add(a64, f64_mul(i32_to_f64(i), interval64));
        }
        ((float64_t*)x_bytes64)[n] = a64;
        ((float64_t*)x_bytes64)[0] = b64;
        x_bytes64[(n+1)*8] = 0x1;  // pin head
        r_data = u3i_bytes(((n+1)*8+1)*sizeof(c3_y), x_bytes64);
        u3a_free(x_bytes64);
        break;
      ...
      case 7: ;
        ...
        c3_y* x_bytes128 = (c3_y*)u3a_malloc(((n+1)*16+1)*sizeof(c3_y));
        float128_t i128;
        for (c3_d i = 1; i < n; i++) {
          i32_to_f128M(i, &i128);
          f128M_mul(&i128, &interval128, &((float128_t*)x_bytes128)[n-i]);
          f128M_add(&a128, &((float128_t*)x_bytes128)[n-i], &((float128_t*)x_bytes128)[n-i]);
        }
        ((float128_t*)x_bytes128)[n] = a128;
        ((float128_t*)x_bytes128)[0] = b128;
        x_bytes128[(n+1)*16] = 0x1;  // pin head
        r_data = u3i_bytes(((n+1)*16+1)*sizeof(c3_y), x_bytes128);
        u3a_free(x_bytes128);
        break;
    }
...
*/
  u3_noun
  u3qi_la_trace_real(u3_noun x_data,
                     u3_noun shape,
                     u3_noun bloq)
  {
    u3_noun d_data = u3qi_la_diag(x_data, shape, bloq);
    c3_d len_x0 = _get_dims(shape)[0];
    u3_noun r_data = u3qi_la_dot_real(d_data, d_data, u3nt(len_x0, 0x1, u3_nul), u3k(bloq));
    return r_data;
  }
...
*/
  u3_noun
  u3qi_la_mmul_real(u3_noun x_data,
                    u3_noun y_data,
                    u3_noun x_shape,
                    u3_noun y_shape,
                    u3_noun bloq)
  {
    ...
    return u3nc(u3nq(u3nt(M_, P_, u3_nul), u3k(bloq), c3__real, u3_nul), r_data);
  }
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_add_real(x_data, y_data, x_shape, x_bloq));
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_sub_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_mul_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_div_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_mod_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_cumsum_real(x_data, x_shape, x_bloq));
  ...
  u3wi_la_argmin(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = u3qi_la_argmin_real(x_data, x_shape, x_bloq);
            // bare atom (@ index)
            return r_data;
  ...
  u3wi_la_ravel(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_ravel_real(x_data, x_shape, x_bloq));
            // (list @)
            return r_data;
  ...
  u3wi_la_argmax(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = u3qi_la_argmax_real(x_data, x_shape, x_bloq);
            // bare atom (@ index)
            return r_data;
  ...
  u3wi_la_min(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_min_real(x_data, x_shape, x_bloq));
            return u3nc(u3nq(u3nt(0x1, 0x1, u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_max(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_max_real(x_data, x_shape, x_bloq));
            return u3nc(u3nq(u3nt(0x1, 0x1, u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_abs(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_abs_real(x_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_gth(u3_noun cor)
  {
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_gth_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_gte(u3_noun cor)
  {
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_gte_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_lth(u3_noun cor)
  {
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_lth_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_lte(u3_noun cor)
  {
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_lte_real(x_data, y_data, x_shape, x_bloq));
            return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_adds(u3_noun cor)
  {
         ...
         c3n == u3ud(n) )
    {
      ...
      switch (x_kind) {
        case c3__real:
          _set_rounding(rnd);
          u3_noun r_data = _soft_run(u3qi_la_adds_real(x_data, n, x_shape, x_bloq));
          return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_subs(u3_noun cor)
  {
         ...
         c3n == u3ud(n) )
    {
      ...
      switch (x_kind) {
        case c3__real:
          _set_rounding(rnd);
          u3_noun r_data = _soft_run(u3qi_la_subs_real(x_data, n, x_shape, x_bloq));
          return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_muls(u3_noun cor)
  {
         ...
         c3n == u3ud(n) )
    {
      ...
      switch (x_kind) {
        case c3__real:
          _set_rounding(rnd);
          u3_noun r_data = _soft_run(u3qi_la_muls_real(x_data, n, x_shape, x_bloq));
          return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_divs(u3_noun cor)
  {
         ...
         c3n == u3ud(n) )
    {
      ...
      switch (x_kind) {
        case c3__real:
          _set_rounding(rnd);
          u3_noun r_data = _soft_run(u3qi_la_divs_real(x_data, n, x_shape, x_bloq));
          return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_mods(u3_noun cor)
  {
         ...
         c3n == u3ud(n) )
    {
      ...
      switch (x_kind) {
        case c3__real:
          _set_rounding(rnd);
          u3_noun r_data = _soft_run(u3qi_la_mods_real(x_data, n, x_shape, x_bloq));
          return u3nc(u3nq(u3k(x_shape), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_dot_real(x_data, y_data, x_shape, x_bloq));
            c3_d len_x0 = _get_dims(x_shape)[0];
            return u3nc(u3nq(u3nt(len_x0, 0x1, u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
  ...
  u3wi_la_transpose(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        return u3nc(u3nq(u3nt(u3k(u3h(x_shape)), u3k(u3h(u3t(x_shape))), u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
      }
    }
  }
                         ...
                         0))
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_linspace_real(a, b, n, x_bloq));
                         ...
                         0))
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_range_real(a, b, d, x_bloq));
            c3_d a_, b_, d_;
            c3_ds n_;
            switch (x_bloq) {
              case 4:
  ...
  u3wi_la_diag(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        u3_noun r_data = _soft_run(u3qi_la_diag(x_data, x_shape, x_bloq));
        c3_d len_x0 = _get_dims(x_shape)[0];
        return u3nc(u3nq(u3nt(len_x0, 0x1, u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
      }
    }
  ...
  u3wi_la_trace(u3_noun cor)
  {
         ...
         c3n == u3ud(x_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real: ;
            u3_noun r_data = _soft_run(u3qi_la_trace_real(x_data, x_shape, x_bloq));
            return u3nc(u3nq(u3nt(0x1, 0x1, u3_nul), u3k(x_bloq), u3k(x_kind), u3k(x_fxp)), r_data);
         ...
         c3n == u3ud(y_data) )
    {
         ...
         )
      {
        ...
        switch (x_kind) {
          case c3__real:
            _set_rounding(rnd);
            u3_noun r_data = _soft_run(u3qi_la_mmul_real(x_data, y_data, x_shape, y_shape, x_bloq));
