...
*/
      ...
      if ( c3n == u3du(n_dom) ) {
        ...
        if ( (u3_nul == l_dom) && (u3_nul == r_dom) ) {
          ...
          if ( u3_nul == yep ) {
            ...
            pro = _loot_in_136(cog, r_dom, nax);
            u3z(nax);
            return pro;
          }
          else {
          ...
          if ( u3_nul == yep ) {
            ...
            pro = _loot_in_136(cog, l_dom, nax);
            u3z(nax);
            return pro;
          }
          else {
          ...
          if ( u3_nul == yep ) {
            ...
            pey = _loot_in_136(cog, l_dom, nax);
            u3z(nax);
  ...
  u3_noun
  u3qf_loot_136(u3_noun cog,
            u3_noun dom)
  {
    return _loot_in_136(cog, dom, 1);
  }
  u3_noun
  u3wf_loot_136(u3_noun cor)
  {
    u3_noun cog, dom;
