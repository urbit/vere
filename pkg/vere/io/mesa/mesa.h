...
static c3_h MESA_COOKIE = 0x67e00200;
...
c3_h mesa_size_pact(u3_mesa_pact* pac_u);
c3_o mesa_is_new_pact(c3_y* buf_y, c3_h len_h);

void mesa_free_pact(u3_mesa_pact* pac_u);

c3_h mesa_etch_pact_to_buf(c3_y* buf_y, c3_h cap_h, u3_mesa_pact *pac_u);
void etcher_init(u3_etcher* ech_u, c3_y* buf_y, c3_h cap_h);
void _mesa_etch_name(u3_etcher *ech_u, u3_mesa_name* nam_u);
c3_c* mesa_sift_pact_from_buf(u3_mesa_pact *pac_u, c3_y* buf_y, c3_h len_h);
