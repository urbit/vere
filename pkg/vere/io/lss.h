...
c3_o lss_verifier_ingest(lss_verifier* ver_u, c3_y* leaf_y, c3_w_new leaf_w, lss_pair* pair);

void lss_verifier_init(lss_verifier* ver_u, c3_w_new steps, c3_w_new leaves, lss_hash* proof, arena* are_u);
