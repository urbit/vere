...
c3_o lss_verifier_ingest(lss_verifier* ver_u, c3_y* leaf_y, c3_w_tmp leaf_w, lss_pair* pair);

void lss_verifier_init(lss_verifier* ver_u, c3_w_tmp steps, c3_w_tmp leaves, lss_hash* proof, arena* are_u);
