...
*/
static u3_hbod*
_cttp_bod_new(c3_w_tmp len_w, c3_c* hun_c)
{
...
{
  c3_w_tmp len_w     = hed_u->nam_w + 2 + hed_u->val_w + 2;
  u3_hbod* bod_u = c3_malloc(1 + len_w + sizeof(*bod_u));
  bod_u->hun_y[len_w] = 0;
...
*/
static void
_cttp_cres_new(u3_creq* ceq_u, c3_w_tmp sas_w)
{
...
{
  c3_w_tmp  len_w = _cttp_mcut_url(0, 0, u3k(pul));
...
{
  {
    c3_w_tmp  len_w = strlen(ceq_u->met_c) + 1 + strlen(ceq_u->url_c) + 12;
...
static void
_cttp_http_client_receive(u3_creq* ceq_u, c3_w_tmp sas_w, u3_noun mes, u3_noun uct)
{
  u3_cttp* ctp_u = ceq_u->ctp_u;
