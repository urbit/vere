  ...
  */
    ...
    */
      typedef struct _u3_book_head {
        c3_h mag_w;      //  magic number: 0x424f4f4b ("BOOK")
        c3_h ver_w;      //  format version: 1
        c3_d fir_d;      //  first event number in file
        c3_d las_d;      //  last event number in file
        c3_h off_w;      //  offset to metadata section
        c3_h len_w;      //  length of metadata section
    ...
    */
      typedef struct _u3_book {
        ...
        c3_h         off_w;      //  append offset (end of last event)
    ...
    */
      typedef struct _u3_book_walk {
        ...
        c3_h off_w;    //  current file offset
