...
#include "c3/c3.h"
  ...
  */
    ...
    **   bat_h is the number of deeds in the latest batch written
    **   sum_h is CRC32 of the latest batch of deeds (for integrity check)
    **   crc_h is CRC32 of preceding fields to detect partial writes
    **
    **   two header slots at offsets 0 and 4096; deeds start at 8192
    */
      typedef struct _u3_book_head {
        c3_h mag_h;      //  magic number: 0x424f4f4b ("BOOK")
        c3_h ver_h;      //  format version: 1
        ...
        c3_d bat_h;      //  number of deeds in latest batch
        c3_h sum_h;      //  CRC32 of latest deed batch data
        c3_h crc_h;      //  CRC32 checksum (of preceding fields)
      } u3_book_head;
    ...
    **     [4 bytes] lif_h (lifecycle length)
    ...
    */
      typedef struct _u3_book_meta {
        ...
        c3_h ver_h;      //  metadata format version
        c3_h lif_h;      //  lifecycle length (4 bytes)
    ...
    */
      typedef struct _u3_book {
        ...
        c3_h         act_h;      //  active header slot a or b (0 or 1)
      } u3_book;
